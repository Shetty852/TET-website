    ...
    <div className="bg-white rounded-lg shadow-md p-8 mb-8">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <div className="bg-primary-50 p-6 rounded-lg">
          <h3 className="text-xl font-semibold mb-3 text-primary-800">Leadership</h3>
        ...
        <div className="bg-white border-2 border-gray-200 p-6 rounded-lg">
          <h3 className="text-2xl font-semibold mb-4 text-gray-800">Student Enrollment Growth</h3>
          <p className="text-gray-600 mb-4">Witnessing remarkable growth in student enrollment over the years</p>
          ...
          <p className="text-center text-sm text-green-600 font-semibold mt-4">
            📈 143% growth from 2022 to 2024!
          </p>
        </div>

        {/* Infrastructure Highlights */}
        <h3 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">World-Class Infrastructure</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white border border-primary-200 p-5 rounded-lg hover:shadow-lg transition-shadow">
          ...
          <div className="bg-white border border-green-200 p-5 rounded-lg hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-3">
